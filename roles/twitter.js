    ...
    cards: [
      {
        ...
        urgency: 3, weeks: 1,
        available: (s) => s.launched && s.customers >= 5 && s.week >= (s.public_complaint_last || 0) + 6,
        options: [
        ...
        dropFx(s) { s.public_complaint_last = s.week; s.signal = clamp(s.signal - 18, 0, 100); s.customers = clamp(s.customers - 8, 0, 9999); },
      },
    ],
  };
