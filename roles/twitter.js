    ...
    cards: [
      {
        ...
        options: [
          { label: 'Respond publicly', key: 'respond',
            execute(s) { s.public_complaint_done = true; s.signal = clamp(s.signal + 5, 0, 100); return "Responded publicly, fixed the issue. Turned a critic into a vocal supporter."; } },
        ],
