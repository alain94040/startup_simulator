"use strict";
// ─────────────────────────────────────────────────────────────────────────────
// tests/test_narrative.js — narrative-consistency fuzzer.
//
// Auto-plays many games across several drivers and seeds, then flags any message
// or open node whose narrative contradicts the game state when it surfaces. The
// engine's seeded RNG keeps every finding replayable, and the shared harness
// owns the drivers.
//
// Two layers:
...
//
// Usage:
//   node tests/test_narrative.js                # full run (all drivers)
//   node tests/test_narrative.js 500            # games per driver (default 300)
//   node tests/test_narrative.js --verbose
//   node tests/test_narrative.js --seed 1234 --driver pivot   # replay w/ trace
//
