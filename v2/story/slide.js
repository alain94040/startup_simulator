// ─────────────────────────────────────────────────────────────────────────────
// v2/story/slide.js — the slide (weeks L+1..L+3): three weeks of gravity after
...
(function () {
  const mod = {
    nodes: [
      ...
      {
        // (v2 deviation: the old `signal < 60` gate is dropped — this card is the
        // sole key to the advisor network that unlocks the investors, and a
